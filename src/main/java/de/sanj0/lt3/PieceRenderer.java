...
// renders pieces!
// The used png located at /src/main/resources/img/pieces.png is from Sebastian Lague
// on github, copyright notice in /src/main/resources/img/pieces.license.txt
public class PieceRenderer {
    ...
    private static SaltyImage getPieceImage(final Spritesheet spritesheet,
        ...
        return ImageUtils.resize(spritesheet.getFrame(x, y).getImage(), width, height, GraphicsConfiguration.renderingHints);
    }
}
